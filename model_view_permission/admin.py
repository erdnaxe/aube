...
class ModelViewPermissionChangeList(ChangeList):
...
class ModelViewPermissionBaseModelAdmin(admin.options.BaseModelAdmin):
    ...
    def has_change_permission(self, request, obj=None):
        ...
        """
        change_permission = super().has_change_permission(request, obj)
    ...
    def get_fields(self, request, obj=None):
        ...
        if ((self.has_view_permission(request, obj) and (
                obj and not self._has_change_only_permission(request,
                                                             obj))) or (
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if ((self.has_view_permission(request, obj) and (
            ...
            if self.fields:
                ...
                if self.model._meta.label == settings.AUTH_USER_MODEL:
                    try:
...
class ModelViewPermissionInlineModelAdmin(ModelViewPermissionBaseModelAdmin,
    ...
    def get_queryset(self, request):
        ...
        if self.has_view_permission(request) and \
            ...
            # get_queryset and ModelViewPermissionBaseModelAdmin which is
            # convinient
            return super().get_queryset(request)


class ModelViewPermissionModelAdmin(ModelViewPermissionBaseModelAdmin,
                                    admin.ModelAdmin):
    def get_changelist(self, request, **kwargs):
        """
        Returns the ChangeList class for use on the changelist page.
        """
        return ModelViewPermissionChangeList

    def get_inline_instances(self, request, obj=None):
        inline_instances = []
        for inline_class in self.inlines:
            new_class = type(
                str('DynamicModelViewPermissionInlineModelAdmin'),
                (inline_class, ModelViewPermissionInlineModelAdmin),
...
class ModelViewPermissionUserAdmin(ModelViewPermissionModelAdmin):
...
class ModelViewPermissionAdminSite(admin.AdminSite):
            ...
            if is_user_model:
                ...
                mutable_admin_class_dict.update({
                    'user_change_password':
                        ModelViewPermissionUserAdmin.user_change_password,
                    'get_form': ModelViewPermissionUserAdmin.get_form,
                })
                # The following won't work if someone overrides the
                # user_change_password view
                admin_class = type(
                    str('DynamicModelViewPermissionModelAdmin'),
                    (ModelViewPermissionUserAdmin, admin_class),
                    dict(mutable_admin_class_dict),
                )
            else:
                admin_class = type(
                    str('DynamicModelViewPermissionModelAdmin'),
                    (admin_class, ModelViewPermissionModelAdmin),
